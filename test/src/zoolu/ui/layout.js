TestCase('ZOOLU.UI.Layout', {
    setUp: function() {
        var layoutCont = $('<div id="layout" class="busy" role="main"/>'),
            westCont = $('<div class="west"/>'),
            centerCont = $('<div class="center" id="center"/>'),
            centerNorthCont = $('<div class="north"/>'),
            centerCenterCont = $('<div class="center"/>');
    ...
    'test layout.panel maximize': function() {
        var currentWidth = $('#layout .west').width(),
            currentHeight = $('#layout .center .north').height();
        try {
            var layout = new ZOOLU.UI.Layout('#layout', {
    ...
    'test layout.panel resize': function() {
        var beginningWidth = $('#layout .west').width(),
            beginningHeight = $('#layout .center .north').height();
