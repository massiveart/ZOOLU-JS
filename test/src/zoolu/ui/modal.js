TestCase('ZOOLU.UI.Modal', {
    ...
    'test modal view add footer buttons': function() {
        ...
        modal.addFooterButtons([
            {content: bContent, callBack: function() {
                2 + 2;
            }, cssClass: bClass, elementId: bId}
        ]);
    ...
    'test initzialize footer buttons': function() {
        ...
        modal.addFooterButtons([
            {content: bContent, callBack: function() {
                2 + 2;
            }, cssClass: 'button', elementId: 'button1'}
        ]);
    ...
    'test initialize the footer dom': function() {
        ...
        modal.addFooterButtons([
            {content: 'Button 1', callBack: function() {
                2 + 2;
            }, cssClass: 'button', elementId: 'button1'}
        ]);
        modal.initFooter();
    ...
    'test modal view close': function() {
        ...
        setTimeout(function() {
            assertEquals('Modal View DOM appended to the body without fadeOut', -1, $('body').html().indexOf(modal.$element.html()));
        }, modal.options.fadeOutDuration + 500);
        setTimeout(function() {
            assertEquals('Modal View DOM appended to the body without fadeOut', -1, $('body').html().indexOf(modal2.$element.html()));
        }, 500);
    },
